...
/// Describes a 32-bit packed RGBA color.
[Serializable]
[DebuggerDisplay("{DebugDisplayString,nq}")]
[StructLayout(LayoutKind.Explicit)]
public struct Color {
    /// The red component of this <see cref="Color"/>
    [FieldOffset(0), NonSerialized] public byte R;

    /// The green component of this <see cref="Color"/>
    [FieldOffset(1), NonSerialized] public byte G;

    /// The blue component of this <see cref="Color"/>
    [FieldOffset(2), NonSerialized] public byte B;

    /// The alpha component of this <see cref="Color"/>
    [FieldOffset(3), NonSerialized] public byte A;
    ...
    public Color(float r, float g, float b) {
        R = byte.CreateSaturating(r * byte.MaxValue);
    ...
    public Color(Vec3 color) {
        R = byte.CreateSaturating(color.X * byte.MaxValue);
